...
class sale_order(osv.osv):
	...
	def _prepare_order_line_procurement(self, cr, uid, order, line, picking_id, date_planned, context=None):
		res = super(sale_order,self)._prepare_order_line_procurement( cr, uid, order, line, picking_id, date_planned, context)
		...
		self._logger.debug('_prepare_order_line_procurement `%s`', res)
		self._logger.debug('_prepare_order_line_procurement `%s`', location_id)
