...
class purchase_order(osv.osv):
    ...
    def _prepare_order_line_move(self, cr, uid, order, order_line, picking_id, context=None): 
        ...
        location_dest_id = order_line.product_id.property_stock_location.id or order_line.product_id.categ_id.property_stock_location.id or order.location_id.id
