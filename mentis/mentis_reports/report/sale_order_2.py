...
class order_2(report_sxw.rml_parse):
    def __init__(self, cr, uid, name, context=None):
        super(order_2, self).__init__(cr, uid, name, context=context)
...
report_sxw.report_sxw('report.sale.order.mentis2', 'sale.order', 'mentis_reports/report/sale_order_2.rml', parser=order_2, header="external")
